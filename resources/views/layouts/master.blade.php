<html style="height: auto;"><head>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <img src="{{asset('img/ome.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Omega Capital</span>
      </a>
    ...
    <div class="content-wrapper" style="min-height: 885.563px;">
